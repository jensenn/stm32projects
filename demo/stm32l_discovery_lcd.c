...
#else
  palSetPadMode(GPIOA, 1, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOA, 2, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOA, 3, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOA, 8, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOA, 9, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOA, 10, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOA, 15, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
#endif
...
#else
  palSetPadMode(GPIOB, 3, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 4, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 5, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 8, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 9, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 10, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 11, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 12, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 13, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 14, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOB, 15, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
#endif
...
#else
  palSetPadMode(GPIOC, 0, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOC, 1, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOC, 2, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOC, 3, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOC, 6, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOC, 7, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOC, 8, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOC, 9, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOC, 10, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
  palSetPadMode(GPIOC, 11, PAL_MODE_ALTERNATE(GPIO_AF_LCD));
#endif
